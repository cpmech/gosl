...
func TestOde01(tst *testing.T) {
	...
	status(tst, err)
	chk.Int(tst, "number of F evaluations ", stat4.Nfeval, 815)
	chk.Int(tst, "number of J evaluations ", stat4.Njeval, 0)
	chk.Int(tst, "total number of steps   ", stat4.Nsteps, 125)
	chk.Int(tst, "number of accepted steps", stat4.Naccepted, 64)
	chk.Int(tst, "number of rejected steps", stat4.Nrejected, 61)
