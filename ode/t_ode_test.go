...
func TestOde01(tst *testing.T) {
	...
	status(tst, err)
	chk.Int(tst, "number of F evaluations ", stat3.Nfeval, 192)
	chk.Int(tst, "number of J evaluations ", stat3.Njeval, 0)
	chk.Int(tst, "total number of steps   ", stat3.Nsteps, 190)
	chk.Int(tst, "number of accepted steps", stat3.Naccepted, 190)
