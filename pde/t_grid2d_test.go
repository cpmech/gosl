...
func TestGrid2d01(tst *testing.T) {

	verbose()
	chk.PrintTitle("Grid2d01. test 01")
	...
	chk.Float64(tst, "Lx", 1e-15, g.Lx, 12.0)
	chk.Float64(tst, "Ly", 1e-15, g.Ly, 6.0)
	chk.Float64(tst, "Dx", 1e-15, g.Dx, 3.0)
	chk.Float64(tst, "Dy", 1e-15, g.Dy, 2.0)
