...
func M_Ts(Ts [][]float64, s []float64) {
    if len(s) == 4 {
        Ts[0][0] = (2*s[0])/3         ; Ts[0][1] = -(2*s[1]+2*s[0])/3 ; Ts[0][2] = -(2*s[2]+2*s[0])/3 ; Ts[0][3] = s[3]/3
        Ts[1][0] = -(2*s[1]+2*s[0])/3 ; Ts[1][1] = (2*s[1])/3         ; Ts[1][2] = -(2*s[2]+2*s[1])/3 ; Ts[1][3] = s[3]/3
        Ts[2][0] = -(2*s[2]+2*s[0])/3 ; Ts[2][1] = -(2*s[2]+2*s[1])/3 ; Ts[2][2] = (2*s[2])/3         ; Ts[2][3] = -(2*s[3])/3
        Ts[3][0] = s[3]/3             ; Ts[3][1] = s[3]/3             ; Ts[3][2] = -(2*s[3])/3        ; Ts[3][3] = s[1]+s[0]
        return
    }
    Ts[0][0] = (2*s[0])/3         ; Ts[0][1] = -(2*s[1]+2*s[0])/3 ; Ts[0][2] = -(2*s[2]+2*s[0])/3 ; Ts[0][3] = s[3]/3      ; Ts[0][4] = -(2*s[4])/3 ; Ts[0][5] = s[5]/3
    Ts[1][0] = -(2*s[1]+2*s[0])/3 ; Ts[1][1] = (2*s[1])/3         ; Ts[1][2] = -(2*s[2]+2*s[1])/3 ; Ts[1][3] = s[3]/3      ; Ts[1][4] = s[4]/3      ; Ts[1][5] = -(2*s[5])/3
    Ts[2][0] = -(2*s[2]+2*s[0])/3 ; Ts[2][1] = -(2*s[2]+2*s[1])/3 ; Ts[2][2] = (2*s[2])/3         ; Ts[2][3] = -(2*s[3])/3 ; Ts[2][4] = s[4]/3      ; Ts[2][5] = s[5]/3
    Ts[3][0] = s[3]/3             ; Ts[3][1] = s[3]/3             ; Ts[3][2] = -(2*s[3])/3        ; Ts[3][3] = s[1]+s[0]   ; Ts[3][4] = s[5]/SQ2    ; Ts[3][5] = s[4]/SQ2
    Ts[4][0] = -(2*s[4])/3        ; Ts[4][1] = s[4]/3             ; Ts[4][2] = s[4]/3             ; Ts[4][3] = s[5]/SQ2    ; Ts[4][4] = s[2]+s[1]   ; Ts[4][5] = s[3]/SQ2
    Ts[5][0] = s[5]/3             ; Ts[5][1] = -(2*s[5])/3        ; Ts[5][2] = s[5]/3             ; Ts[5][3] = s[4]/SQ2    ; Ts[5][4] = s[3]/SQ2    ; Ts[5][5] = s[2]+s[0]
}
