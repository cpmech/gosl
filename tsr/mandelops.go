...
func M_SqDeriv(d [][]float64, a []float64) {
    if len(a) == 4 {
        d[0][0] = 2*a[0] ; d[0][1] = 0      ; d[0][2] = 0      ; d[0][3] = a[3]
        d[1][0] = 0      ; d[1][1] = 2*a[1] ; d[1][2] = 0      ; d[1][3] = a[3]
        d[2][0] = 0      ; d[2][1] = 0      ; d[2][2] = 2*a[2] ; d[2][3] = 0
        d[3][0] = a[3]   ; d[3][1] = a[3]   ; d[3][2] = 0      ; d[3][3] = a[1]+a[0]
        return
    }
    d[0][0] = 2*a[0] ; d[0][1] = 0      ; d[0][2] = 0      ; d[0][3] = a[3]      ; d[0][4] = 0         ; d[0][5] = a[5]
    d[1][0] = 0      ; d[1][1] = 2*a[1] ; d[1][2] = 0      ; d[1][3] = a[3]      ; d[1][4] = a[4]      ; d[1][5] = 0
    d[2][0] = 0      ; d[2][1] = 0      ; d[2][2] = 2*a[2] ; d[2][3] = 0         ; d[2][4] = a[4]      ; d[2][5] = a[5]
    d[3][0] = a[3]   ; d[3][1] = a[3]   ; d[3][2] = 0      ; d[3][3] = a[1]+a[0] ; d[3][4] = a[5]/SQ2  ; d[3][5] = a[4]/SQ2
    d[4][0] = 0      ; d[4][1] = a[4]   ; d[4][2] = a[4]   ; d[4][3] = a[5]/SQ2  ; d[4][4] = a[2]+a[1] ; d[4][5] = a[3]/SQ2
    d[5][0] = a[5]   ; d[5][1] = 0      ; d[5][2] = a[5]   ; d[5][3] = a[4]/SQ2  ; d[5][4] = a[3]/SQ2  ; d[5][5] = a[2]+a[0]
}
...
func M_InvDeriv(d [][]float64, ai []float64) {
    if len(ai) == 4 {
        d[0][0] = -ai[0]*ai[0]     ; d[0][1] = -ai[3]*ai[3]/2.0 ; d[0][2] = 0            ; d[0][3] = -ai[0]*ai[3]
        d[1][0] = -ai[3]*ai[3]/2.0 ; d[1][1] = -ai[1]*ai[1]     ; d[1][2] = 0            ; d[1][3] = -ai[1]*ai[3]
        d[2][0] = 0                ; d[2][1] = 0                ; d[2][2] = -ai[2]*ai[2] ; d[2][3] = 0
        d[3][0] = -ai[0]*ai[3]     ; d[3][1] = -ai[1]*ai[3]     ; d[3][2] = 0            ; d[3][3] = -(ai[3]*ai[3]+2.0*ai[0]*ai[1])/2.0
        return
    }
    d[0][0] = -ai[0]*ai[0]     ; d[0][1] = -ai[3]*ai[3]/2.0 ; d[0][2] = -ai[5]*ai[5]/2.0 ; d[0][3] = -ai[0]*ai[3]                              ; d[0][4] = -ai[3]*ai[5]/SQ2                          ; d[0][5] = -ai[0]*ai[5]
    d[1][0] = -ai[3]*ai[3]/2.0 ; d[1][1] = -ai[1]*ai[1]     ; d[1][2] = -ai[4]*ai[4]/2.0 ; d[1][3] = -ai[1]*ai[3]                              ; d[1][4] = -ai[1]*ai[4]                              ; d[1][5] = -ai[3]*ai[4]/SQ2
    d[2][0] = -ai[5]*ai[5]/2.0 ; d[2][1] = -ai[4]*ai[4]/2.0 ; d[2][2] = -ai[2]*ai[2]     ; d[2][3] = -ai[4]*ai[5]/SQ2                          ; d[2][4] = -ai[2]*ai[4]                              ; d[2][5] = -ai[2]*ai[5]
    d[3][0] = -ai[0]*ai[3]     ; d[3][1] = -ai[1]*ai[3]     ; d[3][2] = -ai[4]*ai[5]/SQ2 ; d[3][3] = -(ai[3]*ai[3]+2.0*ai[0]*ai[1])/2.0        ; d[3][4] = -(2.0*ai[1]*ai[5]+SQ2*ai[3]*ai[4])/TWOSQ2 ; d[3][5] = -(SQ2*ai[3]*ai[5]+2.0*ai[0]*ai[4])/TWOSQ2
    d[4][0] = -ai[3]*ai[5]/SQ2 ; d[4][1] = -ai[1]*ai[4]     ; d[4][2] = -ai[2]*ai[4]     ; d[4][3] = -(2.0*ai[1]*ai[5]+SQ2*ai[3]*ai[4])/TWOSQ2 ; d[4][4] = -(ai[4]*ai[4]+2.0*ai[1]*ai[2])/2.0        ; d[4][5] = -(SQ2*ai[4]*ai[5]+2.0*ai[2]*ai[3])/TWOSQ2
    d[5][0] = -ai[0]*ai[5]     ; d[5][1] = -ai[3]*ai[4]/SQ2 ; d[5][2] = -ai[2]*ai[5]     ; d[5][3] = -(SQ2*ai[3]*ai[5]+2.0*ai[0]*ai[4])/TWOSQ2 ; d[5][4] = -(SQ2*ai[4]*ai[5]+2.0*ai[2]*ai[3])/TWOSQ2 ; d[5][5] = -(ai[5]*ai[5]+2.0*ai[0]*ai[2])/2.0
}
