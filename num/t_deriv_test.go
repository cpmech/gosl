...
func f2    (x float64, args ...interface{}) float64 { if x >= 0.0 { return   x * math.Sqrt (x) }        ; return 0.0 }
func df2dx (x float64, args ...interface{}) float64 { if x >= 0.0 { return 1.5 * math.Sqrt (x) }        ; return 0.0 }
func f3    (x float64, args ...interface{}) float64 { if x != 0.0 { return  math.Sin(1 / x) }           ; return 0.0 }
func df3dx (x float64, args ...interface{}) float64 { if x != 0.0 { return -math.Cos(1 / x) / (x * x) } ; return 0.0 }
