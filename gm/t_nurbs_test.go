...
func Test_nurbs09(tst *testing.T) {
	...
	l0s2a0 := b.IndsAlongCurve(0, 2, 0)
	l0s3a0 := b.IndsAlongCurve(0, 3, 0)
	l0s4a0 := b.IndsAlongCurve(0, 4, 0)
	l0s2a1 := b.IndsAlongCurve(0, 2, 1)
	l0s3a1 := b.IndsAlongCurve(0, 3, 1)
	l0s4a1 := b.IndsAlongCurve(0, 4, 1)
	l1s1a0 := b.IndsAlongCurve(1, 1, 0)
	l1s1a1 := b.IndsAlongCurve(1, 1, 1)
	l1s1a2 := b.IndsAlongCurve(1, 1, 2)
	l1s1a3 := b.IndsAlongCurve(1, 1, 3)
	l1s1a4 := b.IndsAlongCurve(1, 1, 4)
...
func Test_nurbs10(tst *testing.T) {
	...
	l0s2a0 := c.IndsAlongCurve(0, 2, 0)
	l0s10a0 := c.IndsAlongCurve(0, 10, 0)
	l0s2a3 := c.IndsAlongCurve(0, 2, 3)
	l0s10a3 := c.IndsAlongCurve(0, 10, 3)
	l1s1a0 := c.IndsAlongCurve(1, 1, 0)
	l1s1a10 := c.IndsAlongCurve(1, 1, 10)
	l1s3a0 := c.IndsAlongCurve(1, 3, 0)
	l1s3a10 := c.IndsAlongCurve(1, 3, 10)
	chk.Ints(tst, "l0s2a0", l0s2a0, []int{0, 1, 2})
