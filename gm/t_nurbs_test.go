...
func Test_nurbs09(tst *testing.T) {
	...
	l0s21 := b.LocalIndsAlongCurve(0, 2, 1)
	l0s31 := b.LocalIndsAlongCurve(0, 3, 1)
	l0s41 := b.LocalIndsAlongCurve(0, 4, 1)
	l0s22 := b.LocalIndsAlongCurve(0, 2, 2)
	l0s32 := b.LocalIndsAlongCurve(0, 3, 2)
	l0s42 := b.LocalIndsAlongCurve(0, 4, 2)
	l1s12 := b.LocalIndsAlongCurve(1, 1, 2)
	l1s13 := b.LocalIndsAlongCurve(1, 1, 3)
	l1s14 := b.LocalIndsAlongCurve(1, 1, 4)
	l1s15 := b.LocalIndsAlongCurve(1, 1, 5)
	l1s16 := b.LocalIndsAlongCurve(1, 1, 6)
	chk.Ints(tst, "l0s21", l0s21, []int{0, 1, 2})
	chk.Ints(tst, "l0s31", l0s31, []int{1, 2, 3})
	chk.Ints(tst, "l0s41", l0s41, []int{2, 3, 4})
	chk.Ints(tst, "l0s22", l0s22, []int{5, 6, 7})
	chk.Ints(tst, "l0s32", l0s32, []int{6, 7, 8})
	chk.Ints(tst, "l0s42", l0s42, []int{7, 8, 9})
	chk.Ints(tst, "l1s12", l1s12, []int{0, 5})
	chk.Ints(tst, "l1s13", l1s13, []int{1, 6})
	chk.Ints(tst, "l1s14", l1s14, []int{2, 7})
	chk.Ints(tst, "l1s15", l1s15, []int{3, 8})
	chk.Ints(tst, "l1s16", l1s16, []int{4, 9})
...
func Test_nurbs10(tst *testing.T) {
	...
	l0s32 := c.LocalIndsAlongCurve(0, 3, 2)
	l0s33 := c.LocalIndsAlongCurve(0, 3, 3)
	l1s23 := c.LocalIndsAlongCurve(1, 2, 3)
	l1s24 := c.LocalIndsAlongCurve(1, 2, 4)
	chk.Ints(tst, "l0s32", l0s32, []int{12, 13, 14})
	chk.Ints(tst, "l0s33", l0s33, []int{23, 24, 25})
	chk.Ints(tst, "l1s23", l1s23, []int{12, 23})
	chk.Ints(tst, "l1s24", l1s24, []int{13, 24})
