...
func Test_nurbs09(tst *testing.T) {
	...
	l0s2a0 := b.LocalIndsAlongCurve(0, 2, 0)
	l0s3a0 := b.LocalIndsAlongCurve(0, 3, 0)
	l0s4a0 := b.LocalIndsAlongCurve(0, 4, 0)
	l0s2a1 := b.LocalIndsAlongCurve(0, 2, 1)
	l0s3a1 := b.LocalIndsAlongCurve(0, 3, 1)
	l0s4a1 := b.LocalIndsAlongCurve(0, 4, 1)
	l1s1a0 := b.LocalIndsAlongCurve(1, 1, 0)
	l1s1a1 := b.LocalIndsAlongCurve(1, 1, 1)
	l1s1a2 := b.LocalIndsAlongCurve(1, 1, 2)
	l1s1a3 := b.LocalIndsAlongCurve(1, 1, 3)
	l1s1a4 := b.LocalIndsAlongCurve(1, 1, 4)
	chk.Ints(tst, "l0s2a0", l0s2a0, []int{0, 1, 2})
	chk.Ints(tst, "l0s3a0", l0s3a0, []int{1, 2, 3})
	chk.Ints(tst, "l0s4a0", l0s4a0, []int{2, 3, 4})
	chk.Ints(tst, "l0s2a1", l0s2a1, []int{5, 6, 7})
	chk.Ints(tst, "l0s3a1", l0s3a1, []int{6, 7, 8})
	chk.Ints(tst, "l0s4a1", l0s4a1, []int{7, 8, 9})
	chk.Ints(tst, "l1s1a0", l1s1a0, []int{0, 5})
	chk.Ints(tst, "l1s1a1", l1s1a1, []int{1, 6})
	chk.Ints(tst, "l1s1a2", l1s1a2, []int{2, 7})
	chk.Ints(tst, "l1s1a3", l1s1a3, []int{3, 8})
	chk.Ints(tst, "l1s1a4", l1s1a4, []int{4, 9})
...
func Test_nurbs10(tst *testing.T) {
	...
	l0s2a0 := c.LocalIndsAlongCurve(0, 2, 0)
	l0s10a0 := c.LocalIndsAlongCurve(0, 10, 0)
	l0s2a3 := c.LocalIndsAlongCurve(0, 2, 3)
	l0s10a3 := c.LocalIndsAlongCurve(0, 10, 3)
	l1s1a0 := c.LocalIndsAlongCurve(1, 1, 0)
	l1s1a10 := c.LocalIndsAlongCurve(1, 1, 10)
	l1s3a0 := c.LocalIndsAlongCurve(1, 3, 0)
	l1s3a10 := c.LocalIndsAlongCurve(1, 3, 10)
	chk.Ints(tst, "l0s2a0", l0s2a0, []int{0, 1, 2})
	chk.Ints(tst, "l0s10a0", l0s10a0, []int{8, 9, 10})
	chk.Ints(tst, "l0s2a3", l0s2a3, []int{33, 34, 35})
	chk.Ints(tst, "l0s10a3", l0s10a3, []int{41, 42, 43})
	chk.Ints(tst, "l1s1a0", l1s1a0, []int{0, 11})
	chk.Ints(tst, "l1s1a10", l1s1a10, []int{10, 21})
