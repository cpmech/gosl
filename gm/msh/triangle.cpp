...
#ifdef ANSI_DECLARATORS
void parsecommandline(int argc, char const **argv, struct behavior *b)
#else /* not ANSI_DECLARATORS */
...
/*****************************************************************************/
/*                                                                           */
/*  TRIfast_expansion_sum_zeroelim()   Sum two expansions, eliminating zero     */
...
#ifdef ANSI_DECLARATORS
int TRIfast_expansion_sum_zeroelim(int elen, REAL *e, int flen, REAL *f, REAL *h)
#else /* not ANSI_DECLARATORS */
int TRIfast_expansion_sum_zeroelim(elen, e, flen, f, h)  /* h cannot be e or f. */
int elen;
REAL *e;
int flen;
REAL *f;
...
/*****************************************************************************/
/*                                                                           */
/*  TRIscale_expansion_zeroelim()   Multiply an expansion by a scalar,          */
...
#ifdef ANSI_DECLARATORS
int TRIscale_expansion_zeroelim(int elen, REAL *e, REAL b, REAL *h)
#else /* not ANSI_DECLARATORS */
int TRIscale_expansion_zeroelim(elen, e, b, h)   /* e and h cannot be the same. */
int elen;
REAL *e;
REAL b;
REAL *h;
...
/*****************************************************************************/
/*                                                                           */
/*  TRIestimate()   Produce a one-word estimate of an expansion's value.        */
/*                                                                           */
...
#ifdef ANSI_DECLARATORS
REAL TRIestimate(int elen, REAL *e)
#else /* not ANSI_DECLARATORS */
REAL TRIestimate(elen, e)
int elen;
REAL *e;
#endif /* not ANSI_DECLARATORS */
...

{
  ...
  u[3] = u3;
  C1length = TRIfast_expansion_sum_zeroelim(4, B, 4, u, C1);

  Two_Product(acx, bcytail, s1, s0);
  Two_Product(acy, bcxtail, t1, t0);
  Two_Two_Diff(s1, s0, t1, t0, u3, u[2], u[1], u[0]);
  u[3] = u3;
  C2length = TRIfast_expansion_sum_zeroelim(C1length, C1, 4, u, C2);

  Two_Product(acxtail, bcytail, s1, s0);
  Two_Product(acytail, bcxtail, t1, t0);
  Two_Two_Diff(s1, s0, t1, t0, u3, u[2], u[1], u[0]);
  u[3] = u3;
  Dlength = TRIfast_expansion_sum_zeroelim(C2length, C2, 4, u, D);
...
#ifdef ANSI_DECLARATORS
REAL TRIincircleadapt(vertex pa, vertex pb, vertex pc, vertex pd, REAL permanent)
#else /* not ANSI_DECLARATORS */
REAL TRIincircleadapt(pa, pb, pc, pd, permanent)
vertex pa;
vertex pb;
vertex pc;
vertex pd;
...

{
  ...
  bc[3] = bc3;
  axbclen = TRIscale_expansion_zeroelim(4, bc, adx, axbc);
  axxbclen = TRIscale_expansion_zeroelim(axbclen, axbc, adx, axxbc);
  aybclen = TRIscale_expansion_zeroelim(4, bc, ady, aybc);
  ayybclen = TRIscale_expansion_zeroelim(aybclen, aybc, ady, ayybc);
  alen = TRIfast_expansion_sum_zeroelim(axxbclen, axxbc, ayybclen, ayybc, adet);
  ...
  bxxcalen = TRIscale_expansion_zeroelim(bxcalen, bxca, bdx, bxxca);
  bycalen = TRIscale_expansion_zeroelim(4, ca, bdy, byca);
  byycalen = TRIscale_expansion_zeroelim(bycalen, byca, bdy, byyca);
  blen = TRIfast_expansion_sum_zeroelim(bxxcalen, bxxca, byycalen, byyca, bdet);

  Two_Product(adx, bdy, adxbdy1, adxbdy0);
  Two_Product(bdx, ady, bdxady1, bdxady0);
  Two_Two_Diff(adxbdy1, adxbdy0, bdxady1, bdxady0, ab3, ab[2], ab[1], ab[0]);
  ab[3] = ab3;
  cxablen = TRIscale_expansion_zeroelim(4, ab, cdx, cxab);
  cxxablen = TRIscale_expansion_zeroelim(cxablen, cxab, cdx, cxxab);
  cyablen = TRIscale_expansion_zeroelim(4, ab, cdy, cyab);
  cyyablen = TRIscale_expansion_zeroelim(cyablen, cyab, cdy, cyyab);
  clen = TRIfast_expansion_sum_zeroelim(cxxablen, cxxab, cyyablen, cyyab, cdet);

  ablen = TRIfast_expansion_sum_zeroelim(alen, adet, blen, bdet, abdet);
  finlength = TRIfast_expansion_sum_zeroelim(ablen, abdet, clen, cdet, fin1);
  ...
  if (adxtail != 0.0) {
    axtbclen = TRIscale_expansion_zeroelim(4, bc, adxtail, axtbc);
    temp16alen = TRIscale_expansion_zeroelim(axtbclen, axtbc, 2.0 * adx,
                                          temp16a);

    axtcclen = TRIscale_expansion_zeroelim(4, cc, adxtail, axtcc);
    temp16blen = TRIscale_expansion_zeroelim(axtcclen, axtcc, bdy, temp16b);

    axtbblen = TRIscale_expansion_zeroelim(4, bb, adxtail, axtbb);
    temp16clen = TRIscale_expansion_zeroelim(axtbblen, axtbb, -cdy, temp16c);

    temp32alen = TRIfast_expansion_sum_zeroelim(temp16alen, temp16a,
                                            temp16blen, temp16b, temp32a);
    temp48len = TRIfast_expansion_sum_zeroelim(temp16clen, temp16c,
                                            temp32alen, temp32a, temp48);
    finlength = TRIfast_expansion_sum_zeroelim(finlength, finnow, temp48len,
                                            temp48, finother);
    finswap = finnow; finnow = finother; finother = finswap;
  }
  if (adytail != 0.0) {
    aytbclen = TRIscale_expansion_zeroelim(4, bc, adytail, aytbc);
    temp16alen = TRIscale_expansion_zeroelim(aytbclen, aytbc, 2.0 * ady,
                                          temp16a);

    aytbblen = TRIscale_expansion_zeroelim(4, bb, adytail, aytbb);
    temp16blen = TRIscale_expansion_zeroelim(aytbblen, aytbb, cdx, temp16b);

    aytcclen = TRIscale_expansion_zeroelim(4, cc, adytail, aytcc);
    temp16clen = TRIscale_expansion_zeroelim(aytcclen, aytcc, -bdx, temp16c);
  ...
  if (bdxtail != 0.0) {
    bxtcalen = TRIscale_expansion_zeroelim(4, ca, bdxtail, bxtca);
    temp16alen = TRIscale_expansion_zeroelim(bxtcalen, bxtca, 2.0 * bdx,
                                          temp16a);

    bxtaalen = TRIscale_expansion_zeroelim(4, aa, bdxtail, bxtaa);
    temp16blen = TRIscale_expansion_zeroelim(bxtaalen, bxtaa, cdy, temp16b);

    bxtcclen = TRIscale_expansion_zeroelim(4, cc, bdxtail, bxtcc);
    temp16clen = TRIscale_expansion_zeroelim(bxtcclen, bxtcc, -ady, temp16c);
  ...
  if (bdytail != 0.0) {
    bytcalen = TRIscale_expansion_zeroelim(4, ca, bdytail, bytca);
    temp16alen = TRIscale_expansion_zeroelim(bytcalen, bytca, 2.0 * bdy,
                                          temp16a);

    bytcclen = TRIscale_expansion_zeroelim(4, cc, bdytail, bytcc);
    temp16blen = TRIscale_expansion_zeroelim(bytcclen, bytcc, adx, temp16b);

    bytaalen = TRIscale_expansion_zeroelim(4, aa, bdytail, bytaa);
    temp16clen = TRIscale_expansion_zeroelim(bytaalen, bytaa, -cdx, temp16c);
  ...
  if (cdxtail != 0.0) {
    cxtablen = TRIscale_expansion_zeroelim(4, ab, cdxtail, cxtab);
    temp16alen = TRIscale_expansion_zeroelim(cxtablen, cxtab, 2.0 * cdx,
                                          temp16a);

    cxtbblen = TRIscale_expansion_zeroelim(4, bb, cdxtail, cxtbb);
    temp16blen = TRIscale_expansion_zeroelim(cxtbblen, cxtbb, ady, temp16b);

    cxtaalen = TRIscale_expansion_zeroelim(4, aa, cdxtail, cxtaa);
    temp16clen = TRIscale_expansion_zeroelim(cxtaalen, cxtaa, -bdy, temp16c);
  ...
  if (cdytail != 0.0) {
    cytablen = TRIscale_expansion_zeroelim(4, ab, cdytail, cytab);
    temp16alen = TRIscale_expansion_zeroelim(cytablen, cytab, 2.0 * cdy,
                                          temp16a);

    cytaalen = TRIscale_expansion_zeroelim(4, aa, cdytail, cytaa);
    temp16blen = TRIscale_expansion_zeroelim(cytaalen, cytaa, bdx, temp16b);

    cytbblen = TRIscale_expansion_zeroelim(4, bb, cdytail, cytbb);
    temp16clen = TRIscale_expansion_zeroelim(cytbblen, cytbb, -adx, temp16c);
  ...
  if ((adxtail != 0.0) || (adytail != 0.0)) {
    if ((bdxtail != 0.0) || (bdytail != 0.0)
      ...
      v[3] = v3;
      bctlen = TRIfast_expansion_sum_zeroelim(4, u, 4, v, bct);
    ...
    if (adxtail != 0.0) {
      temp16alen = TRIscale_expansion_zeroelim(axtbclen, axtbc, adxtail, temp16a);
      axtbctlen = TRIscale_expansion_zeroelim(bctlen, bct, adxtail, axtbct);
      temp32alen = TRIscale_expansion_zeroelim(axtbctlen, axtbct, 2.0 * adx,
                                            temp32a);
      temp48len = TRIfast_expansion_sum_zeroelim(temp16alen, temp16a,
                                              temp32alen, temp32a, temp48);
      finlength = TRIfast_expansion_sum_zeroelim(finlength, finnow, temp48len,
                                              temp48, finother);
      finswap = finnow; finnow = finother; finother = finswap;
      if (bdytail != 0.0) {
        temp8len = TRIscale_expansion_zeroelim(4, cc, adxtail, temp8);
        temp16alen = TRIscale_expansion_zeroelim(temp8len, temp8, bdytail,
                                              temp16a);
        finlength = TRIfast_expansion_sum_zeroelim(finlength, finnow, temp16alen,
                                                temp16a, finother);
        finswap = finnow; finnow = finother; finother = finswap;
      }
      if (cdytail != 0.0) {
        temp8len = TRIscale_expansion_zeroelim(4, bb, -adxtail, temp8);
        temp16alen = TRIscale_expansion_zeroelim(temp8len, temp8, cdytail,
                                              temp16a);
        finlength = TRIfast_expansion_sum_zeroelim(finlength, finnow, temp16alen,
                                                temp16a, finother);
        finswap = finnow; finnow = finother; finother = finswap;
      ...
      temp32alen = TRIscale_expansion_zeroelim(axtbctlen, axtbct, adxtail,
                                            temp32a);
      axtbcttlen = TRIscale_expansion_zeroelim(bcttlen, bctt, adxtail, axtbctt);
      temp16alen = TRIscale_expansion_zeroelim(axtbcttlen, axtbctt, 2.0 * adx,
                                            temp16a);
      temp16blen = TRIscale_expansion_zeroelim(axtbcttlen, axtbctt, adxtail,
                                            temp16b);
      temp32blen = TRIfast_expansion_sum_zeroelim(temp16alen, temp16a,
                                              temp16blen, temp16b, temp32b);
      temp64len = TRIfast_expansion_sum_zeroelim(temp32alen, temp32a,
                                              temp32blen, temp32b, temp64);
      finlength = TRIfast_expansion_sum_zeroelim(finlength, finnow, temp64len,
                                              temp64, finother);
      finswap = finnow; finnow = finother; finother = finswap;
    }
    if (adytail != 0.0) {
      temp16alen = TRIscale_expansion_zeroelim(aytbclen, aytbc, adytail, temp16a);
      aytbctlen = TRIscale_expansion_zeroelim(bctlen, bct, adytail, aytbct);
      temp32alen = TRIscale_expansion_zeroelim(aytbctlen, aytbct, 2.0 * ady,
                                            temp32a);
      temp48len = TRIfast_expansion_sum_zeroelim(temp16alen, temp16a,
                                              temp32alen, temp32a, temp48);
      finlength = TRIfast_expansion_sum_zeroelim(finlength, finnow, temp48len,
      ...
      temp32alen = TRIscale_expansion_zeroelim(aytbctlen, aytbct, adytail,
                                            temp32a);
      aytbcttlen = TRIscale_expansion_zeroelim(bcttlen, bctt, adytail, aytbctt);
      temp16alen = TRIscale_expansion_zeroelim(aytbcttlen, aytbctt, 2.0 * ady,
                                            temp16a);
      temp16blen = TRIscale_expansion_zeroelim(aytbcttlen, aytbctt, adytail,
                                            temp16b);
      temp32blen = TRIfast_expansion_sum_zeroelim(temp16alen, temp16a,
                                              temp16blen, temp16b, temp32b);
      temp64len = TRIfast_expansion_sum_zeroelim(temp32alen, temp32a,
  ...
  if ((bdxtail != 0.0) || (bdytail != 0.0)) {
    if ((cdxtail != 0.0) || (cdytail != 0.0)
      ...
      Two_Two_Sum(ti1, ti0, tj1, tj0, v3, v[2], v[1], v[0]);
      v[3] = v3;
      catlen = TRIfast_expansion_sum_zeroelim(4, u, 4, v, cat);
    ...
    if (bdxtail != 0.0) {
      temp16alen = TRIscale_expansion_zeroelim(bxtcalen, bxtca, bdxtail, temp16a);
      bxtcatlen = TRIscale_expansion_zeroelim(catlen, cat, bdxtail, bxtcat);
      temp32alen = TRIscale_expansion_zeroelim(bxtcatlen, bxtcat, 2.0 * bdx,
                                            temp32a);
      temp48len = TRIfast_expansion_sum_zeroelim(temp16alen, temp16a,
                                              temp32alen, temp32a, temp48);
      finlength = TRIfast_expansion_sum_zeroelim(finlength, finnow, temp48len,
      ...
      finswap = finnow; finnow = finother; finother = finswap;
      if (cdytail != 0.0) {
        temp8len = TRIscale_expansion_zeroelim(4, aa, bdxtail, temp8);
        temp16alen = TRIscale_expansion_zeroelim(temp8len, temp8, cdytail,
                                              temp16a);
        finlength = TRIfast_expansion_sum_zeroelim(finlength, finnow, temp16alen,
                                                temp16a, finother);
      ...
      if (adytail != 0.0) {
        temp8len = TRIscale_expansion_zeroelim(4, cc, -bdxtail, temp8);
        temp16alen = TRIscale_expansion_zeroelim(temp8len, temp8, adytail,
                                              temp16a);
        finlength = TRIfast_expansion_sum_zeroelim(finlength, finnow, temp16alen,
                                                temp16a, finother);
        finswap = finnow; finnow = finother; finother = finswap;
      ...
      temp32alen = TRIscale_expansion_zeroelim(bxtcatlen, bxtcat, bdxtail,
                                            temp32a);
      bxtcattlen = TRIscale_expansion_zeroelim(cattlen, catt, bdxtail, bxtcatt);
      temp16alen = TRIscale_expansion_zeroelim(bxtcattlen, bxtcatt, 2.0 * bdx,
                                            temp16a);
      temp16blen = TRIscale_expansion_zeroelim(bxtcattlen, bxtcatt, bdxtail,
                                            temp16b);
      temp32blen = TRIfast_expansion_sum_zeroelim(temp16alen, temp16a,
                                              temp16blen, temp16b, temp32b);
      temp64len = TRIfast_expansion_sum_zeroelim(temp32alen, temp32a,
    ...
    if (bdytail != 0.0) {
      temp16alen = TRIscale_expansion_zeroelim(bytcalen, bytca, bdytail, temp16a);
      bytcatlen = TRIscale_expansion_zeroelim(catlen, cat, bdytail, bytcat);
      temp32alen = TRIscale_expansion_zeroelim(bytcatlen, bytcat, 2.0 * bdy,
                                            temp32a);
      temp48len = TRIfast_expansion_sum_zeroelim(temp16alen, temp16a,
                                              temp32alen, temp32a, temp48);
      finlength = TRIfast_expansion_sum_zeroelim(finlength, finnow, temp48len,
      ...
      temp32alen = TRIscale_expansion_zeroelim(bytcatlen, bytcat, bdytail,
                                            temp32a);
      bytcattlen = TRIscale_expansion_zeroelim(cattlen, catt, bdytail, bytcatt);
      temp16alen = TRIscale_expansion_zeroelim(bytcattlen, bytcatt, 2.0 * bdy,
                                            temp16a);
      temp16blen = TRIscale_expansion_zeroelim(bytcattlen, bytcatt, bdytail,
                                            temp16b);
      temp32blen = TRIfast_expansion_sum_zeroelim(temp16alen, temp16a,
                                              temp16blen, temp16b, temp32b);
      temp64len = TRIfast_expansion_sum_zeroelim(temp32alen, temp32a,
  ...
  if ((cdxtail != 0.0) || (cdytail != 0.0)) {
    if ((adxtail != 0.0) || (adytail != 0.0)
      ...
      Two_Two_Sum(ti1, ti0, tj1, tj0, v3, v[2], v[1], v[0]);
      v[3] = v3;
      abtlen = TRIfast_expansion_sum_zeroelim(4, u, 4, v, abt);
    ...
    if (cdxtail != 0.0) {
      temp16alen = TRIscale_expansion_zeroelim(cxtablen, cxtab, cdxtail, temp16a);
      cxtabtlen = TRIscale_expansion_zeroelim(abtlen, abt, cdxtail, cxtabt);
      temp32alen = TRIscale_expansion_zeroelim(cxtabtlen, cxtabt, 2.0 * cdx,
                                            temp32a);
      temp48len = TRIfast_expansion_sum_zeroelim(temp16alen, temp16a,
                                              temp32alen, temp32a, temp48);
      finlength = TRIfast_expansion_sum_zeroelim(finlength, finnow, temp48len,
      ...
      finswap = finnow; finnow = finother; finother = finswap;
      if (adytail != 0.0) {
        temp8len = TRIscale_expansion_zeroelim(4, bb, cdxtail, temp8);
        temp16alen = TRIscale_expansion_zeroelim(temp8len, temp8, adytail,
                                              temp16a);
        finlength = TRIfast_expansion_sum_zeroelim(finlength, finnow, temp16alen,
                                                temp16a, finother);
      ...
      if (bdytail != 0.0) {
        temp8len = TRIscale_expansion_zeroelim(4, aa, -cdxtail, temp8);
        temp16alen = TRIscale_expansion_zeroelim(temp8len, temp8, bdytail,
                                              temp16a);
        finlength = TRIfast_expansion_sum_zeroelim(finlength, finnow, temp16alen,
                                                temp16a, finother);
      ...
      temp32alen = TRIscale_expansion_zeroelim(cxtabtlen, cxtabt, cdxtail,
                                            temp32a);
      cxtabttlen = TRIscale_expansion_zeroelim(abttlen, abtt, cdxtail, cxtabtt);
      temp16alen = TRIscale_expansion_zeroelim(cxtabttlen, cxtabtt, 2.0 * cdx,
                                            temp16a);
      temp16blen = TRIscale_expansion_zeroelim(cxtabttlen, cxtabtt, cdxtail,
                                            temp16b);
      temp32blen = TRIfast_expansion_sum_zeroelim(temp16alen, temp16a,
                                              temp16blen, temp16b, temp32b);
      temp64len = TRIfast_expansion_sum_zeroelim(temp32alen, temp32a,
    ...
    if (cdytail != 0.0) {
      temp16alen = TRIscale_expansion_zeroelim(cytablen, cytab, cdytail, temp16a);
      cytabtlen = TRIscale_expansion_zeroelim(abtlen, abt, cdytail, cytabt);
      temp32alen = TRIscale_expansion_zeroelim(cytabtlen, cytabt, 2.0 * cdy,
                                            temp32a);
      temp48len = TRIfast_expansion_sum_zeroelim(temp16alen, temp16a,
                                              temp32alen, temp32a, temp48);
      finlength = TRIfast_expansion_sum_zeroelim(finlength, finnow, temp48len,
      ...
      temp32alen = TRIscale_expansion_zeroelim(cytabtlen, cytabt, cdytail,
                                            temp32a);
      cytabttlen = TRIscale_expansion_zeroelim(abttlen, abtt, cdytail, cytabtt);
      temp16alen = TRIscale_expansion_zeroelim(cytabttlen, cytabtt, 2.0 * cdy,
                                            temp16a);
      temp16blen = TRIscale_expansion_zeroelim(cytabttlen, cytabtt, cdytail,
                                            temp16b);
      temp32blen = TRIfast_expansion_sum_zeroelim(temp16alen, temp16a,
                                              temp16blen, temp16b, temp32b);
      temp64len = TRIfast_expansion_sum_zeroelim(temp32alen, temp32a,
...

{
  ...
  return TRIincircleadapt(pa, pb, pc, pd, permanent);
}
...

{
  ...
  Two_Two_Diff(bdxcdy1, bdxcdy0, cdxbdy1, cdxbdy0, bc3, bc[2], bc[1], bc[0]);
  bc[3] = bc3;
  alen = TRIscale_expansion_zeroelim(4, bc, adheight, adet);

  Two_Product(cdx, ady, cdxady1, cdxady0);
  Two_Product(adx, cdy, adxcdy1, adxcdy0);
  Two_Two_Diff(cdxady1, cdxady0, adxcdy1, adxcdy0, ca3, ca[2], ca[1], ca[0]);
  ca[3] = ca3;
  blen = TRIscale_expansion_zeroelim(4, ca, bdheight, bdet);

  Two_Product(adx, bdy, adxbdy1, adxbdy0);
  Two_Product(bdx, ady, bdxady1, bdxady0);
  Two_Two_Diff(adxbdy1, adxbdy0, bdxady1, bdxady0, ab3, ab[2], ab[1], ab[0]);
  ab[3] = ab3;
  clen = TRIscale_expansion_zeroelim(4, ab, cdheight, cdet);
  ...
  bctlen = TRIfast_expansion_sum_zeroelim(bt_clen, bt_c, ct_blen, ct_b, bct);
  wlength = TRIscale_expansion_zeroelim(bctlen, bct, adheight, w);
  finlength = TRIfast_expansion_sum_zeroelim(finlength, finnow, wlength, w,
                                          finother);
  finswap = finnow; finnow = finother; finother = finswap;

  catlen = TRIfast_expansion_sum_zeroelim(ct_alen, ct_a, at_clen, at_c, cat);
  wlength = TRIscale_expansion_zeroelim(catlen, cat, bdheight, w);
  finlength = TRIfast_expansion_sum_zeroelim(finlength, finnow, wlength, w,
                                          finother);
  finswap = finnow; finnow = finother; finother = finswap;

  abtlen = TRIfast_expansion_sum_zeroelim(at_blen, at_b, bt_alen, bt_a, abt);
  wlength = TRIscale_expansion_zeroelim(abtlen, abt, cdheight, w);
  finlength = TRIfast_expansion_sum_zeroelim(finlength, finnow, wlength, w,
                                          finother);
  finswap = finnow; finnow = finother; finother = finswap;

  if (adheighttail != 0.0) {
    vlength = TRIscale_expansion_zeroelim(4, bc, adheighttail, v);
    finlength = TRIfast_expansion_sum_zeroelim(finlength, finnow, vlength, v,
                                            finother);
    finswap = finnow; finnow = finother; finother = finswap;
  }
  if (bdheighttail != 0.0) {
    vlength = TRIscale_expansion_zeroelim(4, ca, bdheighttail, v);
    finlength = TRIfast_expansion_sum_zeroelim(finlength, finnow, vlength, v,
                                            finother);
    finswap = finnow; finnow = finother; finother = finswap;
  }
  if (cdheighttail != 0.0) {
    vlength = TRIscale_expansion_zeroelim(4, ab, cdheighttail, v);
    finlength = TRIfast_expansion_sum_zeroelim(finlength, finnow, vlength, v,
                                            finother);
    finswap = finnow; finnow = finother; finother = finswap;
  }
  ...
  if (adxtail != 0.0) {
    if (bdytail != 0.0) {
      ...
      u[3] = u3;
      finlength = TRIfast_expansion_sum_zeroelim(finlength, finnow, 4, u,
                                              finother);
      finswap = finnow; finnow = finother; finother = finswap;
      if (cdheighttail != 0.0) {
  ...
  if (adheighttail != 0.0) {
    wlength = TRIscale_expansion_zeroelim(bctlen, bct, adheighttail, w);
    finlength = TRIfast_expansion_sum_zeroelim(finlength, finnow, wlength, w,
                                            finother);
    finswap = finnow; finnow = finother; finother = finswap;
  }
  if (bdheighttail != 0.0) {
    wlength = TRIscale_expansion_zeroelim(catlen, cat, bdheighttail, w);
    finlength = TRIfast_expansion_sum_zeroelim(finlength, finnow, wlength, w,
                                            finother);
    finswap = finnow; finnow = finother; finother = finswap;
  }
  if (cdheighttail != 0.0) {
    wlength = TRIscale_expansion_zeroelim(abtlen, abt, cdheighttail, w);
    finlength = TRIfast_expansion_sum_zeroelim(finlength, finnow, wlength, w,
                                            finother);
    finswap = finnow; finnow = finother; finother = finswap;
  }
